...
const pageTitles = {
  ...
  '/referrals': 'Referral Plans & Commissions',
  '/transactions': 'Transactions',
  '/support-tickets': 'Support Tickets & Helpdesk',
  '/support-channels': 'Official Support Channels',
        ...
        <div className="relative" ref={profileRef}>
          ...
          >
            ...
            <div className="hidden md:block text-left">
              ...
              <p className="text-[11px] text-gray-400">admin@horizoncap.com</p>
            </div>
            ...
            <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-2xl shadow-xl border border-gray-100 z-50 animate-slide-up overflow-hidden">
              ...
              <div className="border-t border-gray-100 p-3">
                <button
                  onClick={() => {
                    setProfileOpen(false);
                    alert('Logging out of Super Admin session...');
                  }}
